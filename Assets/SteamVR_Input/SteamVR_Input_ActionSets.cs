...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_StimulusNotice p_StimulusNotice;
        ...
        public static SteamVR_Input_ActionSet_StimulusNotice StimulusNotice
        {
            get
            {
                return SteamVR_Actions.p_StimulusNotice.GetCopy<SteamVR_Input_ActionSet_StimulusNotice>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_StimulusNotice = ((SteamVR_Input_ActionSet_StimulusNotice)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_StimulusNotice>("/actions/StimulusNotice")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.StimulusNotice};
        }
    }
}
