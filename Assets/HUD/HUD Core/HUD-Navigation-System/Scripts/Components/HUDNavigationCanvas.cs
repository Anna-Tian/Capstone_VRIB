...
namespace SickscoreGames.HUDNavigationSystem
{
	...
	public class HUDNavigationCanvas : MonoBehaviour
	{
        ...
        public _ARC4References ARC4;

        public _CompassBarReferences BehindCompass;
		...
		public void UpdateRadar (Transform rotationReference, RadarModes radarType)
		{
			...
			if (radarType == RadarModes.RotateRadar) {
				// set radar rotation
                Radar.Radar.transform.localRotation = Quaternion.Euler(0, 0, rotationReference.eulerAngles.y);
		...
		public void UpdateCompassBar (Transform rotationReference)
		{
            ...
            CompassBar.backCompass.uvRect = new Rect((rotationReference.eulerAngles.y / 360f), 0f, 1f, 1f);
        ...
        {
            // check references
            if (ARC4.Panel == null || ARC4.Circle == null || ARC4.ElementContainer == null)
            {
                ReferencesMissing("ARC4");
                return;
            }
        ...
        public void ShowARC4(bool value)
        {
            if (ARC4.Panel != null)
                ARC4.Panel.gameObject.SetActive(value);
        }


        public void UpdateARC4(Transform rotationReference, RadarModes radarType)
        {
           /* // assign map / player indicator rotation
            if (radarType == RadarModes.RotateRadar)
            {
		...
		public class _CompassBarReferences
		{
            ...
            public RawImage backCompass;
            public RectTransform backElementContainer;
		}
        ...
        [System.Serializable]
        public class _ARC4References
        {
            public RectTransform Panel;
            public RectTransform Circle;
            public RectTransform Degrees;
            public RectTransform PlayerIndicator;
            public RectTransform ElementContainer;
        }
        #endregion
