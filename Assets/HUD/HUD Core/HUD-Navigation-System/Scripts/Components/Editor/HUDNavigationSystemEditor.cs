...
public class HUDNavigationSystemEditor : HUDNavigationBaseEditor
{
	...
	private bool _radar_, _compassBar_, _indicator_, _minimap_,_ARC4_;
	#endregion
	...
	protected override void OnBaseInspectorGUI ()
	{
        ...
        SerializedProperty _pUseARC4 = serializedObject.FindProperty("useARC4");
        ...
        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PropertyField(_pUseARC4, new GUIContent("ARC4 Feature"));
        EditorGUILayout.LabelField((hudTarget.useARC4) ? "ENABLED" : "DISABLED", (hudTarget.useARC4) ? enabledStyle : disabledStyle, GUILayout.Width(100));
        EditorGUILayout.EndHorizontal();
        GUILayout.Space (8); // SPACE
