...
public class HUDNavigationCanvasEditor : HUDNavigationBaseEditor
{
	...
	protected override void OnBaseInspectorGUI ()
	{
        ...
        SerializedProperty _pARC4 = serializedObject.FindProperty("ARC4");
        ...
        // ARC4 references
        EditorGUILayout.BeginVertical(boxStyle);
        _ARC4_ = EditorGUILayout.BeginToggleGroup("ARC4 References", _ARC4_);
        DrawReferences(_pARC4, _ARC4_);
        EditorGUILayout.EndToggleGroup();
        EditorGUILayout.EndVertical();
