...
namespace SickscoreGames.HUDNavigationSystem
{
	...
	public class HUDNavigationElement : MonoBehaviour
	{
		...
		void InitializeSettings ()
		{
            ...
            //ARC4 settings
            this.hideInARC4 = Settings.hideInARC4;
		}
		...
		void CreateRadarMarker ()
		{
            ...
            Radar.DistanceText.transform.localPosition += new Vector3(20, 20);
            Radar.Icon.transform.localScale += new Vector3(2, 2, 0);
            //Radar.DistanceText.text = "";
        }
		...
		void CreateIndicatorMarker ()
		{
            ...
            Indicator.transform.localScale += new Vector3(1, 1, 0);
        }
        ...
        void CreateARC4Marker()
        {
            if (Prefabs.RadarPrefab == null)
                return;
            //Create ARC4 gameobject
            GameObject ARC4GO = Instantiate(Prefabs.RadarPrefab.gameObject, Vector3.zero, Quaternion.identity) as GameObject;
            ARC4GO.transform.SetParent(HUDNavigationCanvas.Instance.ARC4.ElementContainer, false);
            ARC4GO.SetActive(false);

            //assign prefab
            ARC4 = ARC4GO.GetComponent<HNSRadarPrefab>();
            ARC4.ArrowAbove.gameObject.SetActive(false);
            ARC4.ArrowBelow.gameObject.SetActive(false);

            ARC4.Icon.transform.localScale += new Vector3(4, 4, 0);
            ARC4.DistanceText.transform.localScale += new Vector3(0.5f, 0.5f, 0);
        }
        #endregion
	}
	...
	[System.Serializable]
	public enum NavigationElementType { Radar, CompassBar, Indicator, Minimap, ARC4 };
